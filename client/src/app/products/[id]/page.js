    ...
    return (
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6">
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-8 text-center">
          ...
          <Link
            href="/products"
            className="mt-6 inline-flex min-h-11 items-center justify-center rounded-xl bg-violet-600 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-violet-500/20 transition hover:bg-violet-500"
          >
            Back to Products
          </Link>
        </div>
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-12">
      ...
      <div className="mt-8 grid gap-8 md:grid-cols-2 md:gap-12">
        {/* Product Image */}
        <div className="relative flex min-h-[360px] items-center justify-center overflow-hidden rounded-3xl border border-white/10 bg-white/[0.03] sm:min-h-[500px]">
          {imageUrl ? (
            <>
              ...
              <img
                src={imageUrl}
                alt={product.name}
                className="max-h-[500px] w-full object-contain p-8 sm:p-12"
              />
            </>
          ) : (
            <div className="text-center">
              <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-3xl border border-white/10 bg-white/[0.04] text-3xl text-zinc-600">
                ◇
              </div>
